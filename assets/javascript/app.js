...
$("#submit").on("click", function (event) {
  ...
  console.log("the first letter: ", uppercaseFirstLetter, stringWithoutFirstLetter)
  console.log("the first letter: ", uppercase2ndLetter, string2)
  var together = uppercaseFirstLetter + stringWithoutFirstLetter + " " + uppercase2ndLetter + string2;
